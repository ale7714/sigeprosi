 <?php
	/*	UNIVERSIDAD SIMON BOLIVAR
		...
		NOMBRE DEL ARCHIVO:	class.ObservacionesEsEvaluado.php
	*/
include_once "fBaseDeDatos.php";

class observacionesesevaluado {
		
		private $idEsEvaluado;
		...
		*/
		public function getAtributosP() {
			$atributos = array();
			$atributos[0] = "idEsEvaluado";
			$atributos[1] = "observaciones";
			return $atributos;
		}
