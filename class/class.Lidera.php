...
class lidera {
		...
		*/
   		function __construct($ced,$idTrim,$nombPro) {
			$this->cedula       = $ced;
			$this->idTrimestre 	= $idTrim;
			$this->nombreProyecto 	= $nombPro;
        }
		...
		Descripcion	: Función que permite la inserción de un lidera en
                      la tabla lidera		
		*/
		...
		*/
		public function getAtributosP() {
			$atributos = array();
			$atributos[0] = "cedula";
			$atributos[1] = "idTrimestre";
			$atributos[2] = "nombreProyecto";
			return $atributos;
		}
