        ...
        <table border="0">
            ...
            <tr>
                <td align="right"><LABEL for="surname"><b>*Planteamiento del problema:</b><br/>(Máx. 500 caracteres)</LABEL></td>
                    <td><textarea name="planteamiento" id="planteamiento" title="Informaci�n referente al problema" rows="10" cols="40" disabled="disabled"><?php print $solicitud['planteamiento']?></textarea></td>
            </tr>
            <tr>
                <td align="right"><LABEL for="surname"><b>¿Dispone de Recursos tecnológicos?<br/>De ser así indique cuáles</b><br/>(Máx. 500 caracteres)</LABEL> </td>
                    <td><textarea name="recursos" id="recursos" title="computadora, servidor, conexi�n a internet, etc." rows="5" cols="40" disabled="disabled"><?php print $solicitud['tecnologia']?></textarea></td>
            </tr>
            <tr>
                <td align="right"><LABEL for="surname"><b>¿Dispone de tiempo libre <br/> para dedicárselo al sistema?</b><br/>(Máx. 500 caracteres) </LABEL> </td>
                    <td><textarea name="tiempolibre" id="tiempolibre" title="Informaci�n acerca de su tiempo libre" rows="5" cols="40" disabled="disabled"><?php print $solicitud['tiempo']?></textarea></td>
            </tr>
            <tr>
...
<tr>
            ...
            <tr>
				    ...
				    <?php //Solo se muestra el bot�n de editar si la solicitud esta en el estado 0 es decir aceptado
						if($solicitud['estado'] == 0){
