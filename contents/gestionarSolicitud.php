	...
	<div class="section_w701"><font size="4" face="arial"><b>Consultar Solicitudes:</b></font>  </div> 
	 <div class="section_w702">
        ...
        <form action="acciones/consultarSolicitud.php" method="post">
			...
			<tr>
				<td>
					<input type="text" value="N&uacute;mero solicitud..." name="numSol" size="10" maxlength="20" class="inputfield" title="N&uacute;mero solicitud" onfocus="clearText(this)" onblur="putText(this)" onkeypress="return onlyAlfaNumbers(event)"/>
				</td>
				<td>
					<input type="text" value="Correo electr&oacute;nico..." name="email" size="10" class="inputfield" title="Correo electr&oacute;nico" onfocus="clearText(this)" onblur="putText(this)" />
				</td>
