<div id="main_column">
    ...
    <div class="section_w700">
        ...
        <h2>Registro de Unidad Administrativa</h2>
    ...
    <div class="section_w700">
        <form name="formaRegistroUnidad" action="" method="post">
        <table border="0">
            <tr>
					<td align="right" width=35.5%><LABEL for="unidad"><b>*Nombre de la Unidad:</b></LABEL> 
                    </td>
                    <td width=64.5%><input title="Ingrese nombre de unidad" type="text" id="unidad" name="unidad" value="" onfocus="clearText(this)" onblur="clearText(this)"/></td>
            </tr>
            ...
            <tr>
                    ...
                    <td colspan="2">
                    <input type="submit" id="enviar" name="enviar" value="Enviar" alt="Enviar" class="submitbutton" title="Enviar Registro" />
