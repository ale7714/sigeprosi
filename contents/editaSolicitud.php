        ...
        <table border="0">
            ...
            <tr>
                <td align="right" width=35.5%><LABEL for="email"><b>*E-mail:</b></LABEL> 
                    ...
                    <td width=64.5%><input title="Correo electr�nico" type="text" id="email" name="email" value="<?php print $solicitud["email"]?>" disabled="disabled"/></td>
            </tr>
            ...
            <tr>
                <td align="right"><LABEL for="surname"><b>¿Cuántas personas ,aproximadamente,<br/>serán beneficiadas por el sistema?</b></LABEL> :</td>
            ...
            <tr>
                <td align="right"><LABEL for="surname"><b>*Planteamiento del problema:</b><br/>(Máx. 500 caracteres)</LABEL></td>
                    <td><textarea name="planteamiento" id="planteamiento" title="Informaci�n referente al problema" rows="10" cols="40" onkeypress="return contadorCaracteres(event)"><?php print $solicitud["planteamiento"]?></textarea></td>
            </tr>
            <tr>
                <td align="right"><LABEL for="surname"><b>*¿Dispone de Recursos tecnológicos?<br/>De ser así indique cuáles</b><br/>(Máx. 500 caracteres)</LABEL> </td>
                    <td><textarea name="recursos" id="recursos" title="computadora, servidor, conexi�n a internet, etc." rows="5" cols="40" onkeypress="return contadorCaracteres(event)"><?php print $solicitud["tecnologia"]?></textarea></td>
            </tr>
            <tr>
                <td align="right"><LABEL for="surname"><b>*¿Dispone de tiempo libre <br/> para dedicárselo al sistema?</b><br/>(Máx. 500 caracteres) </LABEL> </td>
                    <td><textarea name="tiempolibre" id="tiempolibre" title="Informaci�n acerca de su tiempo libre" rows="5" cols="40" onkeypress="return contadorCaracteres(event)"><?php print $solicitud["tiempo"]?></textarea></td>
            </tr>
            <tr>
				...
				<?php
					  ...
					  while($i < $j){
					     echo '<tr><td align="right"><LABEL for="surname" width=35.3%><b>*Teléfono:</b></LABEL> </td>
							...
							</select>-<input title="Ingrese su n�mero de tel�fono" type="text" name="tlf[]" id="tlf[]" value="'.substr($telefonos[$i],4,11).'" maxlength="7" size="7" onkeypress="return onlyNumbers(event)"/></td></tr>
