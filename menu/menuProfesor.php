<div id="templatemo_menu_wrapper">
	...
	<div id="templatemo_menu">
    	<ul>
            ...
            <li><a href="?content=gestionarEvaluacion" <?php if (($page=='gestionarEvaluacion') || ($page=='registroEvaluacion') || ($page=='consultoEvaluacion') || ($page=='editaEvaluacion')){?>class="current fast"<?php }?>><b>Evaluaciones</b></a></li>
            ...
            <li><a href="?content=gestionarSolicitud" <?php if ($page=='gestionarSolicitud'){?>class="current fast"<?php }?>><b>Solicitudes</b></a></li>
						...
						<li><a href="?content=consultarDocumentos" <?php if ($page=='consultarDocumentos'){?>class="current fast"<?php }?>><b>Documentos</b></a></li>
        </ul>
    </div> <!-- end of menu -->
