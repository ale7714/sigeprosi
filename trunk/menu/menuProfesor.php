<div id="templatemo_menu_wrapper">
	...
	<div id="templatemo_menu">
    	<ul>
            ...
            <li><a href="?content=gestionarEquipo" <?if ($page=='equipos'){?>class="current fast"<?}?>><b>Equipos</b></a></li>
            <li><a href="?content=gestionarProyecto" <?if ($page=='proyectos'){?>class="current fast"<?}?>><b>Proyectos</b></a></li>
