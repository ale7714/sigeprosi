		...
		<table width="60%"  border="0">
			<tr >
                <td  colspan="2" >
					...
					<input type="image" width="50" height="50" id="enviar" name="enviar" src="images/ICO/Save.ico" alt="Actualizar Planificacion" class="submitbutton" title="Actualizar Planificacion"  />
                </td>
            </tr>
		</table>
