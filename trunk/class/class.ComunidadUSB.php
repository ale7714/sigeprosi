 <?php
	/*	UNIVERSIDAD SIMON BOLIVAR
		...
		NOMBRE DEL ARCHIVO:	class.ComunidadUSB.php
	*/
include_once "fBaseDeDatos.php";

class comunidadusb extends usuario {
		...
		*/
   		function __construct($i,$ced, $tC, $tP, $tE, $tA) {
			$this->id            = $i;
			$this->cedula        = $ced;
			$this->tipoCliente   = $tC;
			$this->tipoProfesor  = $tP;
			$this->tipoEvauador  = $tE;
			$this->tipoAdmin     = $tA;
        }
		...
		*/
		public function getAtributosP() {
			...
			$atributos[0] = "id";
			$atributos[1] = "cedula";
			$atributos[2] = "tipoCliente";
			$atributos[3] = "tipoProfesor";
			$atributos[4] = "tipoEvaluador";
			$atributos[5] = "tipoAdmin";
			return $atributos;
		}
