...
class esevaluado {
		...
		*/
   		function __construct($idAvan,$carnetEst,$cedComUSB,$nota) {
			$this->idAvance       		= $idAvan;
			$this->carnetEstudiante 	= $carnetEst;
			$this->cedulaComunidadUSB 	= $cedComUSB;
			$this->nota    				= $nota;
        }
		...
		*/
		public function getAtributosP() {
			$atributos = array();
			$atributos[0] = "idAvance";
			$atributos[1] = "carnetEstudiante";
			$atributos[2] = "cedulaComunidadUSB";
			$atributos[3] = "nota";
			return $atributos;
		}
